...
if os.path.exists(malicious_kon):
        ...
        if os.path.exists(malicious_kb_kon):
                ...
                if malicious_kb_kur == 'y':
                        ...
                        os.system('sleep 1')
                        os.system('cd $HOME')
                        os.system('git clone https://github.com/howlingwolf61/TKBK')
                        os.system('mv TKBK/Malicious ../usr/bin')
                        os.system('cd ../usr/bin')
                        os.system('chmod +x Malicious')
                        os.system('cd $Home')
                        os.system('rm -rf TKBK')
...
if os.path.exists(malicious_kon):
        ...
        if os.path.exists(malicious_kb_kon):
                ...
                if malicious_kb_kur == 'y':
                        ...
                        os.system('cd $HOME')
                        os.system('git clone https://github.com/howlingwolf61/TKBK')
                        os.system('mv TKBK/A-Rat ../usr/bin')
                        os.system('cd ../usr/bin')
                        os.system('chmod +x A-Rat')
                        os.system('cd $Home && rm -rf TKBK')
                        os.system('sleep 1 && echo')
